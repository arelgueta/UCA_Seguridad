...
\newtcolorbox{cajaMentoring}[1][]{
  ...
  title={\ding{211}\; Mentoring docente}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaFeedback}[1][]{
  colback=verdeFeedback!8, colframe=verdeFeedback,
  fonttitle=\bfseries\color{verdeFeedback},
  title={\ding{51}\; Coevaluaci\'on entre pares}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaDefensa}[1][]{
  colback=doradoFinal!10, colframe=doradoFinal,
  fonttitle=\bfseries\color{doradoFinal},
  title={\ding{73}\; Ensayo de defensa oral}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}
...
\newtcolorbox{cajaChecklist}[1][]{
  ...
  fonttitle=\bfseries\color{verdeFeedback},
  title={Checklist del dossier}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaCierre}[1][]{
  colback=rojoAlerta!8, colframe=rojoAlerta,
  fonttitle=\bfseries\color{rojoAlerta}, title=Camino a la Clase 15, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}
