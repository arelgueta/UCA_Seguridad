...
\newtcolorbox{cajaAmenaza}[1][]{
  colback=naranjaAmenaza!10, colframe=naranjaAmenaza,
  fonttitle=\bfseries\color{naranjaAmenaza},
  title={\ding{55}\; Amenaza}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaHerramienta}[1][]{
  colback=verdeOK!10, colframe=verdeOK,
  fonttitle=\bfseries\color{verdeOK},
  title={\ding{45}\; Herramienta}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaCaso}[1][]{
  colback=doradoUCA!10, colframe=doradoUCA,
  fonttitle=\bfseries, title=Caso de Estudio, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
...
\newtcolorbox{cajaNota}[1][]{
  ...
  fonttitle=\bfseries\color{rojoAlerta}, title=Nota Importante, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
