...
\newtcolorbox{cajaLegal}[1][]{
  ...
  title={\ding{211}\; Marco Legal}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
...
\newtcolorbox{cajaNota}[1][]{
  ...
  fonttitle=\bfseries\color{rojoAlerta}, title=Atenci\'on Negocio, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
