...
\newtcolorbox{cajaConcepto}[1][]{
  ...
  fonttitle=\bfseries\color{azulUCA}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
...
\newtcolorbox{cajaNota}[1][]{
  ...
  fonttitle=\bfseries\color{rojoAlerta}, title=Importante, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaCierre}[1][]{
  colback=doradoUCA!10, colframe=doradoUCA,
  fonttitle=\bfseries, title=Cierre de Unidad, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
