...
\newtcolorbox{cajaContinuidad}[1][]{
  colback=azulContinuidad!8, colframe=azulContinuidad,
  fonttitle=\bfseries\color{azulContinuidad},
  title={\ding{211}\; Continuidad de Negocio}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaAuditoria}[1][]{
  colback=verdeAuditoria!8, colframe=verdeAuditoria,
  fonttitle=\bfseries\color{verdeAuditoria},
  title={\ding{52}\; Auditor\'ia de Seguridad}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
...
\newtcolorbox{cajaIA}[1][]{
  ...
  title={\ding{211}\; Actividad con Inteligencia Artificial}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
...
\newtcolorbox{cajaChecklist}[1][]{
  ...
  fonttitle=\bfseries\color{verdeAuditoria},
  title={Checklist de auditor\'ia (NIST SP 800-61 + ISO 27001)}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaCierre}[1][]{
  colback=rojoAlerta!8, colframe=rojoAlerta,
  fonttitle=\bfseries\color{rojoAlerta}, title=Cierre de Unidad 4, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
