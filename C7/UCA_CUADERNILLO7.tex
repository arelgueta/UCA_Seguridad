...
\newtcolorbox{cajaDefinicion}[1][]{
  ...
  fonttitle=\bfseries, title=Definici\'on, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaNube}[1][]{
  colback=azulNube!8, colframe=azulNube,
  fonttitle=\bfseries\color{azulNube},
  title={\ding{41}\; En la nube}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaConcepto}[1][]{
  colback=doradoUCA!10, colframe=doradoUCA,
  fonttitle=\bfseries, title=Concepto clave, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaCaso}[1][]{
  colback=rojoAlerta!8, colframe=rojoAlerta,
  fonttitle=\bfseries\color{rojoAlerta}, title=Caso real, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaActividad}[1][]{
  colback=grisClaro, colframe=azulUCA,
  fonttitle=\bfseries\color{azulUCA},
  title={\ding{45}\; Actividad Pr\'actica}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}

\newtcolorbox{cajaNota}[1][]{
  colback=naranjaAmenaza!10, colframe=naranjaAmenaza,
  fonttitle=\bfseries\color{naranjaAmenaza}, title=Para tu TP Integrador, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt, #1
}
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
\hline
\rowcolor{azulUCA!20}
...
\begin{tabularx}{\textwidth}{|>{\bfseries\color{azulNube}\raggedright\arraybackslash}p{2.6cm}|X|X|}
\hline
\rowcolor{grisClaro}
...
\begin{tabularx}{\textwidth}{|>{\bfseries\color{rojoAlerta}\raggedright\arraybackslash}p{4.2cm}|X|}
\hline
\rowcolor{grisClaro}
...
\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}p{0.8cm}|X|>{\centering\arraybackslash}p{3.3cm}|}
\hline
\rowcolor{azulUCA!20}
