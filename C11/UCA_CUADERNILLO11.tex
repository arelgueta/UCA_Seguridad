...
\newtcolorbox{cajaGobierno}[1][]{
  colback=azulGobierno!8, colframe=azulGobierno,
  fonttitle=\bfseries\color{azulGobierno},
  title={\ding{211}\; Gobierno de la Seguridad}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaPSA}[1][]{
  colback=verdePSA!8, colframe=verdePSA,
  fonttitle=\bfseries\color{verdePSA},
  title={\ding{45}\; Pol\'itica de Seguridad Aceptable}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaParcial}[1][]{
  colback=violetaParcial!8, colframe=violetaParcial,
  fonttitle=\bfseries\color{violetaParcial},
  title={\ding{115}\; PARCIAL 2}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
