...
\newtcolorbox{cajaParcial}[1][]{
  ...
  title={\ding{115}\; PARCIAL 1}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaNota}[1][]{
  colback=rojoAlerta!8, colframe=rojoAlerta,
  fonttitle=\bfseries\color{rojoAlerta}, title=Nota de Negocio, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
