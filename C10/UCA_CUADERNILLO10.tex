...
\newtcolorbox{cajaHacker}[1][]{
  colback=verdeTerminal!8, colframe=verdeTerminal,
  fonttitle=\bfseries\color{verdeTerminal},
  title={\ding{211}\; Hacking \'Etico}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaReglas}[1][]{
  colback=rojoAlerta!12, colframe=rojoAlerta,
  fonttitle=\bfseries\color{rojoAlerta},
  title={\ding{55}\; REGLAS DE JUEGO OBLIGATORIAS}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
