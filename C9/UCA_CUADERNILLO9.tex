...
\newtcolorbox{cajaEtica}[1][]{
  ...
  title={\ding{73}\; \'Etica y Privacidad}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaCookie}[1][]{
  colback=azulCookie!8, colframe=azulCookie,
  fonttitle=\bfseries\color{azulCookie},
  title={\ding{80}\; Cookies y Rastreo}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
