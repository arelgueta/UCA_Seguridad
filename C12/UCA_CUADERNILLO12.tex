...
\newtcolorbox{cajaCrisis}[1][]{
  colback=rojoCrisis!8, colframe=rojoCrisis,
  fonttitle=\bfseries\color{rojoCrisis},
  title={\ding{55}\; JUNTA DE CRISIS}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaInyeccion}[1][]{
  colback=naranjaAmenaza!12, colframe=naranjaAmenaza,
  fonttitle=\bfseries\color{naranjaAmenaza},
  title={\ding{115}\; Punto de inyecci\'on}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
...
\newtcolorbox{cajaActividad}[1][]{
  ...
  title={\ding{45}\; Actividad Pr\'actica}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaNota}[1][]{
  colback=doradoUCA!10, colframe=doradoUCA,
  fonttitle=\bfseries, title=Concepto clave, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaRolGerente}[1][]{
  colback=rolGerente!10, colframe=rolGerente,
  fonttitle=\bfseries\color{rolGerente},
  title={Rol: GERENCIA GENERAL}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaRolLegal}[1][]{
  colback=rolLegal!10, colframe=rolLegal,
  fonttitle=\bfseries\color{rolLegal},
  title={Rol: LEGAL / CUMPLIMIENTO}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaRolComunicaciones}[1][]{
  colback=rolComunicaciones!10, colframe=rolComunicaciones,
  fonttitle=\bfseries\color{rolComunicaciones},
  title={Rol: COMUNICACIONES}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}

\newtcolorbox{cajaRolTI}[1][]{
  colback=rolTI!10, colframe=rolTI,
  fonttitle=\bfseries\color{rolTI},
  title={Rol: TI / SEGURIDAD}, arc=3mm, breakable, boxrule=0.6pt, left=7pt, right=7pt, top=5pt, bottom=5pt,
  #1
}
